  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>회화 복습</Text>
        <Text style={styles.desc}>이전에 학습한 회화 상황을 다시 연습해보세요</Text>
        <Text style={styles.count}>복습 가능: 3개</Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  count: { fontSize: 16, fontWeight: '700', color: '#CE82FF' },
});
